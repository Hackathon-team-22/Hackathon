...
//                    content = @Content(schema = @Schema(implementation = CountByPeriodDto.class)))
//    )
...
//                    content = @Content(schema = @Schema(implementation = TransactionTypeDto.class)))
//    )
...
//                    content = @Content(schema = @Schema(implementation = AmountComparisonDto.class)))
//    )
...
//                    content = @Content(schema = @Schema(implementation = ExecutionStatusDto.class)))
//    )
...
//                    content = @Content(schema = @Schema(implementation = BankStatDto.class)))
//    )
...
//                    content = @Content(schema = @Schema(implementation = CategoryStatDto.class)))
//    )
